  ...
  <div v-if="show" class="modal-overlay">
    <div class="modal-content">
      <div class="modal-header-section">
        ...
        <p class="modal-subtitle">Completa los datos para registrar una nueva actividad</p>
      </div>
      <TaskForm @saved="handleSubmit" @cancel="$emit('close')"/>
    </div>
  </div>
</template>

<script>
import TaskForm from './ActividadForm.vue'
