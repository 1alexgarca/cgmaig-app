  ...
  >
    <div class="modal-content">
      <div class="modal-header-section">
        ...
        <p class="modal-subtitle">Revisa los detalles y el historial de la actividad completada</p>
      </div>
      <CompletadoForm 
...
<script>
import CompletadoForm from './CompletadoForm.vue';

export default {
  components: { CompletadoForm },
  props: {
    show: Boolean,
    initialData: Object
  },
